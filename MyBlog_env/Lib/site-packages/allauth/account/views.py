...
class EmailView(AjaxCapableProcessFormViewMixin, FormView):
    ...
    def _action_send(self, request, *args, **kwargs):
        ...
        try:
            ...
            return HttpResponseRedirect('/accounts/profile/')#self.get_success_url()修改为指定自定义页面——————————————————————————————————————————————————
...
class PasswordChangeView(AjaxCapableProcessFormViewMixin, FormView):
    ...
    success_url = reverse_lazy("account_login") #account_change_password_____________修改密码成功跳转登录即跳转个人主页_______________________________
